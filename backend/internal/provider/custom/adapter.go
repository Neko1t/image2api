...
// Adapter wraps the existing custom.Client to implement adapter.UpstreamAdapter.
...
// mapAdapterError converts custom package errors to adapter.ErrAdapter* sentinels
